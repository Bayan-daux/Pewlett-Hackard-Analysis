-- Retirement eligibility (1st try)
...
-- Create Table for Retirement eligibility
SELECT first_name, last_name
...
-- Joining retirement_info and dept_emp tables into current_info table
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
-- Reorder current_emp_by_dept Table by dept.
